...
#define XASSET_OBJECT_API(XAssetObjectType)                                                                                                              \
	template <>                                                                                                                                            \
	struct Signature<XAssetObjectType>                                                                                                                     \
	{                                                                                                                                                      \
		Signature() = default;                                                                                                                               \
...
#define XASSET_READ_API(XAssetObjectType)                                                                                                                                   \
	...
	DM_INLINE const char *requet_get_type_name(const Request<XAssetObjectType> &req)                                                                                          \
	{                                                                                                                                                                         \
		DM_MAYBE_UNUSED(req);                                                                                                                                                   \
		return DM_NAMEOF(XAssetObjectType);                                                                                                                                     \
	}                                                                                                                                                                         \
	DM_INLINE bool request_valid(const Request<XAssetObjectType> &req)                                                                                                        \
	{                                                                                                                                                                         \
		DM_MAYBE_UNUSED(req);                                                                                                                                                   \
		return true;                                                                                                                                                            \
	}                                                                                                                                                                         \
